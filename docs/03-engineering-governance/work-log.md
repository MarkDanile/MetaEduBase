...
| 2026-06-08 | DOC-034 修正 REQ-008 spec AC-5 与实际测试行为不一致 | 文档 / 验收口径修正 / follow-up |  |  | `docs/02-delivery-plans/01-specs/2026-W23-req-008-req-004-quality-follow-up.md` / `docs/01-product-planning/04-backlog.md` |
