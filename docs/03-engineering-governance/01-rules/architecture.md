...
API DTO、前端 service DTO、shared schema/type 之间有任意一处变化时，按 `docs/03-engineering-governance/01-rules/contracts.md` 同步，而不是只在某一端静默修改。
...
| 本地启动和常用命令 | `docs/03-engineering-governance/01-rules/local-development.md` |
| 测试策略 | `docs/03-engineering-governance/01-rules/testing.md` |
| 数据完整性与级联清理 | `docs/03-engineering-governance/01-rules/data-integrity.md` |
| 当前任务与交接状态 | `docs/03-engineering-governance/current-work.md` |
