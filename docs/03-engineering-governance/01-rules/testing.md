...
如果你要看具体门禁命令组合，继续读 `docs/03-engineering-governance/01-rules/quality-gates.md`。如果你要初始化测试库或运行本地命令，继续读 `docs/03-engineering-governance/01-rules/local-development.md`。
