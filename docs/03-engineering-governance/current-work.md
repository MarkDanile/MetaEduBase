...
|------|------|--------|------|----------|--------|------|
| TD-063 ds_parse 返 parsed row count | 🟡 进行中 | P1 | 后端 / Structured Data | 切 `fix/td-063-ds-parse-return`；4 mock pytest 全过；40/40 mock pytest 0 回归。 | push + PR → merge。 | mock pytest + ruff + check-engineering-docs。 |
...
| 2026-06-13 | TD-057 task 函数返回值契约（10 个 _do 修复合片系列） | 🟡 进行中 | slice 1~4 已完工（chunk_document #258 / parse_document #260 / embed_chunks #262 / index_tsvector #264）。剩 6 个 follow-up TD-061~TD-066 待修。 | [TD-057](technical-debt.md#td-057) / [PR #258](https://github.com/MarkDanile/MetaEduBase/pull/258) |
