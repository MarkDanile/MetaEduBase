...
| TD-034 | `build_fields_desc` 在 `array + items=[]` 时丢失"成员为 object"提示 | 🟡 进行中 | P3 | 后端 / LLM 抽取 / 可维护性 | REQ-005 / [PR #109](https://github.com/MarkDanile/MetaEduBase/pull/109) (`4773741`) |
