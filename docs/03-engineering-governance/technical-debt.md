...
| TD-087 | 模板管理 API 缺少后端 RBAC | ⚫ 待办 | P1 | 后端 / Template / Identity / RBAC / 多租户 | [REQ-060 R1 PR #493](https://github.com/MarkDanile/MetaEduBase/pull/493)：`/api/v1/templates/*` 仅认证无角色授权；是 `/data/templates*` 受保护路由迁移前置 |
