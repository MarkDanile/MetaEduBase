...
| TD-064 | ds_extract_kg 返 KG entity/relation counts dict | 🔵 就绪 | P1 | 后端 / Structured Data / KG | TD-057 9 个 follow-up slice 8：ds_extract_kg._do 返 `{"entities": N, "relations": M}` dict；outer 补 `return`。| TD-057 9 个 follow-up slice 8：ds_extract_kg._do 返 `{"entities": N, "relations": M}` dict；outer 补 `return`。|
