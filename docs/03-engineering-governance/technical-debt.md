...
| TD-081 | CI、Git hooks 与 mypy 可执行基线缺失 | 🟣 待验证 | P1 | 工程基础设施 / CI / Hooks / Typing | 三路 CI、fresh PostgreSQL、可安装 hooks、mypy 可递减基线和测试环境覆盖已实现；等待真实 PR Actions + main required checks 验证。 |
