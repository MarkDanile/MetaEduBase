...
| TD-087 | 模板管理 API 缺少后端 RBAC | 🟡 进行中 | P1 | 后端 / Template / Identity / RBAC / 多租户 | [PR #495](https://github.com/MarkDanile/MetaEduBase/pull/495)：15 个管理端点统一高权守卫，最小 lookup DTO 与完整角色 / 租户矩阵待最终复审 |
