...
| TD-085 | 收口 AI Chat、Skill 与 Agent App 的上下文边界倒置 | 🟡 进行中 | P1 | 后端 / Agent Platform / DDD / 可维护性 | [REQ-059](../01-product-planning/05-requirements/REQ-059-enterprise-agent-platform-kernel.md) / 2026-07-23 源码复核 + 2026-09-15 Phase 0 审计 + 2026-09-17 readiness decision gate + 2026-09-18 Slice A 启动 + 2026-09-20 Slice A 合并（PR #627）+ 2026-09-22 Slice B 合并（PR #629） |
