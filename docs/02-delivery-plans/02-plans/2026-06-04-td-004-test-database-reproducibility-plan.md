...
**Spec:** [docs/02-delivery-plans/01-specs/2026-06-04-td-004-test-database-reproducibility.md](../01-specs/2026-06-04-td-004-test-database-reproducibility.md)
**技术债条目:** [docs/03-engineering-governance/technical-debt.md#td-004-让后端测试数据库环境可复现](../../03-engineering-governance/technical-debt.md)
...
- **Modify:** `docs/03-engineering-governance/01-rules/local-development.md` — 新增测试库小节 + Makefile 行。
- **Modify:** `docs/03-engineering-governance/01-rules/quality-gates.md` — 更新已知门禁状态。
- **Modify:** `README.md:154-156` — 后端测试段补一行。
- **Modify:** `docs/03-engineering-governance/current-work.md` — 任务卡片登记 + 收尾。
- **Modify:** `docs/03-engineering-governance/technical-debt.md` — TD-004 状态收口。
- **Modify:** `docs/03-engineering-governance/work-log.md` — 一行索引。
...
**Files:**
- Modify: `docs/03-engineering-governance/01-rules/local-development.md`
...
```bash
git add docs/03-engineering-governance/01-rules/local-development.md
...
```bash
git add docs/03-engineering-governance/01-rules/quality-gates.md
...
- `TD-004`：让后端测试数据库环境可复现。详见 `docs/03-engineering-governance/technical-debt.md`。
```
...
需求来源：
- Spec: `docs/02-delivery-plans/01-specs/2026-06-04-td-004-test-database-reproducibility.md`
- Plan: `docs/02-delivery-plans/02-plans/2026-06-04-td-004-test-database-reproducibility-plan.md`
- 技术债：`docs/03-engineering-governance/technical-debt.md#td-004-让后端测试数据库环境可复现`
- 架构约束：`docs/03-engineering-governance/01-rules/local-development.md`，`docs/03-engineering-governance/01-rules/quality-gates.md`
- 插件输出：
- 任务模式：`docs/03-engineering-governance/task-modes.md#技术债修复`
...
git add docs/02-delivery-plans/01-specs/2026-06-04-td-004-test-database-reproducibility.md \
        docs/02-delivery-plans/02-plans/2026-06-04-td-004-test-database-reproducibility-plan.md \
...
**Files:**
- Modify: `docs/03-engineering-governance/technical-debt.md`（TD-004 段落）
...
```md
- 2026-06-04 — TD-004 后端测试数据库可复现 — Spec `docs/02-delivery-plans/01-specs/2026-06-04-td-004-test-database-reproducibility.md`，Plan `docs/02-delivery-plans/02-plans/2026-06-04-td-004-test-database-reproducibility-plan.md`
```
...
> 按 `docs/03-engineering-governance/01-rules/git-workflow.md#完整交付闭环` 推进。

- [x] **Step 1：再次回读 current-work.md，确认状态与事实一致**

Run：
```bash
sed -n '/TD-004/,/^###/p' docs/03-engineering-governance/current-work.md | head -60
```
...
- Spec：[docs/02-delivery-plans/01-specs/2026-06-04-td-004-test-database-reproducibility.md](../01-specs/2026-06-04-td-004-test-database-reproducibility.md)
- Plan：[docs/02-delivery-plans/02-plans/2026-06-04-td-004-test-database-reproducibility-plan.md](2026-06-04-td-004-test-database-reproducibility-plan.md)
- 技术债：TD-004
...
把 `docs/03-engineering-governance/current-work.md`「最近完成」中的 TD-004 卡片 `交接备注` 末行、`docs/03-engineering-governance/technical-debt.md` TD-004 `备注` 末段、`docs/03-engineering-governance/work-log.md` 对应行的回填占位替换为真实编号；2026-06-04 实际替换为：`PR #23`（https://github.com/MarkDanile/MetaEduBase/pull/23）；merge commit `b8b34a6`；完成日期 `2026-06-04`。
...
把真实编号写回三处，commit：
```bash
git add docs/03-engineering-governance/current-work.md docs/03-engineering-governance/technical-debt.md docs/03-engineering-governance/work-log.md
