...
> 交付历史（2026-06-05）：TD-018 已通过 PR #41 合并到 `main`，merge commit `8ad15e6`。本文保留为历史实施计划；下方清单已按最终交付状态收口，真实交付事实以 `docs/03-engineering-governance/technical-debt.md#td-018-filedetailview-剩余手写-load-迁到-vue-query` 和 PR #41 为准。TD-018 后续暴露的 Vue Query 自引用问题已由 TD-019 / PR #42 修复。

## 任务入口

- Spec: `docs/02-delivery-plans/01-specs/2026-06-05-td-018-filedetailview-remaining.md`
- 技术债: `docs/03-engineering-governance/technical-debt.md#td-018-filedetailview-剩余手写-load-迁到-vue-query`
- 任务卡片: `docs/03-engineering-governance/current-work.md` 的 TD-018 卡片
- 当前执行模式: `manual`
