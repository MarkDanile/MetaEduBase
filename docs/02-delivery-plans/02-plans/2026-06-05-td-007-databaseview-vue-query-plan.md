...
> **交付历史（2026-06-05）：** TD-007 已通过 PR #36（merge commit `350acd2`）合并到 `main`。本文保留为历史实施计划；下方清单已按最终交付状态收口，真实交付事实以 `docs/03-engineering-governance/technical-debt.md#td-007-减少前端请求状态处理重复` 和 PR #36 为准。

## 任务入口

- Spec: `docs/02-delivery-plans/01-specs/2026-06-05-td-007-databaseview-vue-query.md`
- 技术债: `docs/03-engineering-governance/technical-debt.md#td-007-减少前端请求状态处理重复`
- 任务卡片: `docs/03-engineering-governance/current-work.md` 的 TD-007 卡片
- 当前执行模式: `manual`
