...
> 交付历史（2026-06-05）：TD-019 已通过 PR #42 合并到 `main`，merge commit `387d8f8`。本文保留为历史实施计划；下方清单已按最终交付状态收口，真实交付事实以 `docs/03-engineering-governance/technical-debt.md#td-019-修复-vue-query-轮询自引用导致的页面初始化运行时错误` 和 PR #42 为准。

## 任务入口

- Spec: `docs/02-delivery-plans/01-specs/2026-06-05-td-019-vue-query-self-reference.md`
- 技术债: `docs/03-engineering-governance/technical-debt.md#td-019-修复-vue-query-轮询自引用导致的页面初始化运行时错误`
- 任务卡片: `docs/03-engineering-governance/current-work.md` 的 TD-019 卡片
- 当前执行模式: `manual`
...
- [x] spec 落盘到 `docs/02-delivery-plans/01-specs/2026-06-05-td-019-vue-query-self-reference.md`
- [x] plan 落盘（本文件）
