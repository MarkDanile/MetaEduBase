...
> **交付历史（2026-06-05）：** TD-015 已通过 PR #38（merge commit `f38fbbc`）合并到 `main`。本文保留为历史实施计划；下方清单已按最终交付状态收口，真实交付事实以 `docs/03-engineering-governance/technical-debt.md#td-015-修复-td-007-databaseview-vue-query-迁移后的行为回归` 和 PR #38 为准。

## 任务入口

- Spec: `docs/02-delivery-plans/01-specs/2026-06-05-td-015-databaseview-regressions.md`
- 技术债: `docs/03-engineering-governance/technical-debt.md#td-015-修复-td-007-databaseview-vue-query-迁移后的行为回归`
- 任务卡片: `docs/03-engineering-governance/current-work.md` 的 TD-015 卡片
- 当前执行模式: `manual`
