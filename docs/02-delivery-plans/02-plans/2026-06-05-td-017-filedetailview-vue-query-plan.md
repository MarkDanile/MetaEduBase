...
> 交付历史（2026-06-05）：TD-017 已通过 PR #40 合并到 `main`，merge commit `5af2793`。本文保留为历史实施计划；下方清单已按最终交付状态收口，真实交付事实以 `docs/03-engineering-governance/technical-debt.md#td-017-将-vue-query-请求生命周期治理推广到-filedetailview` 和 PR #40 为准。TD-017 后续暴露的 Vue Query 自引用问题已由 TD-019 / PR #42 修复。

## 任务入口

- Spec: `docs/02-delivery-plans/01-specs/2026-06-05-td-017-filedetailview-vue-query.md`
- 技术债: `docs/03-engineering-governance/technical-debt.md#td-017-将-vue-query-请求生命周期治理推广到-filedetailview`
- 任务卡片: `docs/03-engineering-governance/current-work.md` 的 TD-017 卡片
- 当前执行模式: `manual`
