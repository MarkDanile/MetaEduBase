...
> Spec：[specs/2026-06-05-td-020-provider-resolver-factory.md](../specs/2026-06-05-td-020-provider-resolver-factory.md)
...
- `docs/engineering/current-work.md`：
  ...
  - 如果 `最近完成` 超过 5 行，最旧一行迁到 `docs/engineering/work-log.md`。
- `docs/engineering/work-log.md`：增加一行索引，指向 PR 与 spec。
- `docs/specs/2026-06-05-td-020-provider-resolver-factory.md` 与本 plan 顶部补"交付历史"段，参考 DOC-010 收口规范。
...
按 `docs/engineering/rules/git-workflow.md`：
