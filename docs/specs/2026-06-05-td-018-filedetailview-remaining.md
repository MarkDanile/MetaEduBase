...
`docs/engineering/technical-debt.md#td-018-filedetailview-剩余手写-load-迁到-vue-query`
...
- 行为等价矩阵 `docs/engineering/matrices/td-018-filedetailview-remaining-equivalence.md`
