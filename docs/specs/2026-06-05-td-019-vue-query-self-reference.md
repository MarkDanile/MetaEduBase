...
`docs/engineering/technical-debt.md#td-019-修复-vue-query-轮询自引用导致的页面初始化运行时错误`
...
- 新增等价矩阵：`docs/engineering/matrices/td-019-vue-query-self-reference-equivalence.md`
...
4. 行为等价矩阵 `docs/engineering/matrices/td-019-vue-query-self-reference-equivalence.md`
   覆盖 polling 计算时机、初始化顺序、watch 时序
...
按 `docs/engineering/rules/quality-gates.md#验证矩阵`：
