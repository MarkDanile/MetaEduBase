...
`docs/engineering/technical-debt.md#td-015-修复-td-007-databaseview-vue-query-迁移后的行为回归`
...
- 写行为等价矩阵 `docs/engineering/matrices/td-015-databaseview-equivalence.md`
...
按 `docs/engineering/rules/testing.md` 与 `local-development.md` 验证：
