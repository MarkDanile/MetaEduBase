...
3. 不大规模重写 `docs/engineering/*` 流程文档，只修正与边界直接冲突的规则。
...
3. `docs/engineering/rules/docs.md` 同步更新顶层文档边界和更新规则。
4. `docs/engineering/rules/architecture.md` 同步为“架构实现约束”而非重复 inventory。
