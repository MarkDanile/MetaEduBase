...
- 任务详情只保留可执行和可复盘摘要；长交付细节放到 PR、spec、plan、矩阵文档或 `docs/engineering/work-log.md`。
...
| 优先级 | P1 |
| 领域 | 测试 / 交付 |
| 事实源 | [Spec](../specs/2026-06-04-td-004-test-database-reproducibility.md), [Plan](../plans/2026-06-04-td-004-test-database-reproducibility-plan.md), [PR #23](https://github.com/MarkDanile/MetaEduBase/pull/23), merge commit `b8b34a6` |
...
| 优先级 | P1 |
| 领域 | 后端 / 可维护性 |
| 事实源 | [Spec](../specs/2026-06-05-td-005-task-lifecycle-helpers.md), [Plan](../plans/2026-06-05-td-005-task-lifecycle-helpers-plan.md), [PR #34](https://github.com/MarkDanile/MetaEduBase/pull/34), merge commit `e5197a5` |
...
| 优先级 | P1 |
| 领域 | 后端 / AI |
| 事实源 | [Spec](../specs/2026-06-05-td-006-llm-model-fallback.md), [Plan](../plans/2026-06-05-td-006-llm-model-fallback-plan.md), [PR #35](https://github.com/MarkDanile/MetaEduBase/pull/35), merge commit `042e4a9` |
...
| 优先级 | P2 |
| 领域 | 前端 / 可维护性 |
| 事实源 | [Spec](../specs/2026-06-05-td-007-databaseview-vue-query.md), [Plan](../plans/2026-06-05-td-007-databaseview-vue-query-plan.md), [PR #36](https://github.com/MarkDanile/MetaEduBase/pull/36), merge commit `350acd2` |
...
| 优先级 | P1 |
| 领域 | 前端 / API / 可维护性 |
| 事实源 | [Spec](../specs/2026-06-05-td-015-databaseview-regressions.md), [Plan](../plans/2026-06-05-td-015-databaseview-regressions-plan.md), [等价矩阵](matrices/td-015-databaseview-equivalence.md), [PR #38](https://github.com/MarkDanile/MetaEduBase/pull/38), merge commit `f38fbbc` |
...
| 优先级 | P1 |
| 领域 | 后端 / AI / 可维护性 |
| 事实源 | [Spec](../specs/2026-06-05-td-016-ai-router-provider.md), [Plan](../plans/2026-06-05-td-016-ai-router-provider-plan.md), [PR #39](https://github.com/MarkDanile/MetaEduBase/pull/39), merge commit `4e6cf42` |
...
| 优先级 | P2 |
| 领域 | 前端 / 可维护性 |
| 事实源 | [Spec](../specs/2026-06-05-td-017-filedetailview-vue-query.md), [Plan](../plans/2026-06-05-td-017-filedetailview-vue-query-plan.md), [等价矩阵](matrices/td-017-filedetailview-equivalence.md), [PR #40](https://github.com/MarkDanile/MetaEduBase/pull/40), merge commit `5af2793` |
...
| 优先级 | P3 |
| 领域 | 前端 / 可维护性 |
| 事实源 | [Spec](../specs/2026-06-05-td-018-filedetailview-remaining.md), [Plan](../plans/2026-06-05-td-018-filedetailview-remaining-plan.md), [等价矩阵](matrices/td-018-filedetailview-remaining-equivalence.md), [PR #41](https://github.com/MarkDanile/MetaEduBase/pull/41), merge commit `8ad15e6` |
...
| 优先级 | P0 |
| 领域 | 前端 / 运行时稳定性 / 测试 |
| 事实源 | [Spec](../specs/2026-06-05-td-019-vue-query-self-reference.md), [Plan](../plans/2026-06-05-td-019-vue-query-self-reference-plan.md), [等价矩阵](matrices/td-019-vue-query-self-reference-equivalence.md), [PR #42](https://github.com/MarkDanile/MetaEduBase/pull/42), merge commit `387d8f8` |
...
| 优先级 | P1 |
| 领域 | 文档 / 工程流程 / 跨 AI 交接 |
| 事实源 | `docs/engineering/rules/quality-gates.md#完成门禁` |
...
| 优先级 | P2 |
| 领域 | 文档 / 工程流程 / 跨 AI 交接 |
| 事实源 | [Spec](../specs/2026-06-05-td-022-close-early-plan-checkboxes.md), [Plan](../plans/2026-06-05-td-022-close-early-plan-checkboxes-plan.md), [PR #44](https://github.com/MarkDanile/MetaEduBase/pull/44), merge commit `f33c19c` |

**证据**
- `rg -n "^- \\[ \\]" docs/plans` 仍命中多个早期已完成任务的历史 plan。
...
- `docs/plans/2026-06-05-td-020-provider-resolver-factory-plan.md:46` 仍保留”优先复用 `_normalize_default_provider`，再决定是否翻译回 `qwen`”的历史风险描述，与最终实现和 TD-023 修复后的 spec 不一致。
...
- 2026-06-05 完成（接手工具：Claude Code）。docs-only + 副本清理，无业务代码变更。
  ...
  2. `docs/specs/2026-06-05-td-020-provider-resolver-factory.md` §3.1 目标第 2 条改为：`provider_resolver` 复用 `factory` 暴露的 `RESOLVER_PROVIDER_NAMES` 与 `resolver_default_provider()` 两个公开事实源，并显式说明 `resolver_default_provider()` 走 resolver 专用 alias 判定、不复用 `factory._normalize_default_provider`。
  ...
  5. `docs/plans/2026-06-05-td-020-provider-resolver-factory-plan.md` 范围段改为：复用 `factory` 公开事实源 `RESOLVER_PROVIDER_NAMES` 与 `resolver_default_provider()`（resolver 走专用 alias 判定，不复用 `factory._normalize_default_provider`）。
