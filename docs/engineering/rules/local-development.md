...
Git 流程见 `docs/engineering/rules/git-workflow.md`，验证矩阵见 `docs/engineering/rules/quality-gates.md`。
...
这类记录应同步到 `docs/engineering/current-work.md`，必要时入账到技术债或 follow-up。
