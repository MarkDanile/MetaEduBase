...
> Status: 🟣 Shaping
> Core Contract: 🟡 Doing（Slice E0；完整 REQ-047 继续 Shaping）
> Priority: P0
...
- Conversation/Message/Run/Event Durable Core 已与 REQ-041 冻结；W1 已合并，E0 正在实施，后续按 E1/B1/A1/R1 推进。两个 context 分别迁移，不共享 ORM/repository。
