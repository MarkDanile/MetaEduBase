...
| 2026-07-17 | 实施完成 | 3 commits 合并到 main (PR #430 d69684ae)：移除 "企业全称" 输入 + business_purpose 改 Optional + migration 020 audit_log nullable + entity_type 空提示含上传指引。803 backend + 16 frontend tests pass |
