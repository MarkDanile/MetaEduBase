...
| REQ-030 | 🟡 部分收口 | P2 RAG 自动质量评估新口径（semantic embedding + LLM-as-judge）(分支 `feat/req-030-new-quality-metric`)：脚本支持四口径（substring/semantic/semantic_embedding/llm_judge）+ 向后兼容 + ScenarioRun 字段 + 报告新增 REQ-030 章节 + dry-run 通过 + 真 LLM 报告生成（LLM-judge AC-5 1/10 达标；semantic_emb 全 0 因硅流 embedding API 在 batch 下挂起）。已登记 REQ-031 接力修复 embedding 通路 | [Requirement](../05-requirements/REQ-030-p2-rag-new-quality-metric.md) / [Backlog](../04-backlog.md) / [Spec](../../02-delivery-plans/01-specs/2026-06-20-req-030-new-quality-metric.md) / [Plan](../../02-delivery-plans/02-plans/2026-06-20-req-030-new-quality-metric-plan.md) / [Report](../../02-delivery-plans/01-specs/2026-06-20-req-030-new-quality-metric-report.md) / [REQ-031](../04-backlog.md) |
