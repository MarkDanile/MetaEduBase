...
| REQ-014 | 🟡 Shaping | RAG 真实 PG 样例、数据回填与回答 grounding 验收 | REQ-013 / BUG-007 / BUG-006 后续统一验收入口：真实样例 backfill、reparse、packed context 摘要、最终回答质量和文档级来源闭环。 | [Requirement](../05-requirements/REQ-014-rag-real-pg-grounding-and-data-backfill-validation.md) |
