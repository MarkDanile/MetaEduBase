...
| REQ-030 | 🟡 部分收口 | P2 RAG 自动质量评估新口径（semantic embedding + LLM-as-judge）(分支 `feat/req-030-new-quality-metric`)：脚本支持四口径（substring/semantic/semantic_embedding/llm_judge）+ 向后兼容 + ScenarioRun 字段 + 报告新增 REQ-030 章节 + dry-run 通过 + 真 LLM 报告生成。REQ-031 接力后 semantic_emb 8/10 非零（通路稳定），但 threshold 0.5 过严致 AC-4/5 仍 0/10，阈值校准留 follow-up | [Requirement](../05-requirements/REQ-030-p2-rag-new-quality-metric.md) / [Backlog](../04-backlog.md) / [Spec](../../02-delivery-plans/01-specs/2026-06-20-req-030-new-quality-metric.md) / [Plan](../../02-delivery-plans/02-plans/2026-06-20-req-030-new-quality-metric-plan.md) / [Report](../../02-delivery-plans/01-specs/2026-06-20-req-030-new-quality-metric-report.md) / [REQ-031](../05-requirements/REQ-031-p2-semantic-embedding-coverage-stabilization.md) |
| REQ-031 | 🟢 完成 | P2 semantic embedding 覆盖率计算稳定性（REQ-030 接力）(分支 `feat/req-031-semantic-embedding-stability`)：进程内 embedding 缓存（hit=1581/miss=259）+ asyncio.wait_for 60s 硬超时 + 降级。timeout=0/error=0 消除 batch 挂起，semantic_emb 从全 0 变为 8/10 非零。REQ-030 AC-4/5 阈值校准留 follow-up | [Requirement](../05-requirements/REQ-031-p2-semantic-embedding-coverage-stabilization.md) / [Backlog](../04-backlog.md) / [Spec](../../02-delivery-plans/01-specs/2026-06-20-req-031-semantic-embedding-stability.md) / [Plan](../../02-delivery-plans/02-plans/2026-06-20-req-031-semantic-embedding-stability-plan.md) / [Report](../../02-delivery-plans/01-specs/2026-06-20-req-030-new-quality-metric-report.md) |
