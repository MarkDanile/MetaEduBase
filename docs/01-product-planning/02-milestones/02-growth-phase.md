...
| REQ-002-1 | 🟡 Doing | 模板配置效率（编辑器 UX：拖拽三层 / 子树复制 / 撤销 / 大模板浏览），实施中 | [Spec](../../02-delivery-plans/01-specs/2026-06-10-req-002-1-template-config-ux.md) / [Backlog](../04-backlog.md) |
| REQ-002-2 | 🟡 Doing | 模板复用机制（同租户复制 / 全量版本快照 / JSON 导入导出），实现进行中 | [Spec](../../02-delivery-plans/01-specs/2026-06-10-req-002-2-template-reuse.md) / [Backlog](../04-backlog.md) |
