...
| REQ-015 | 🟣 待验证 | RAG 生产链路 grounding 与真实验收收口 | BUG-009 修复后真 dev DB prompt 前证据链已恢复；用户授权后完整 DeepSeek ask 已通过，等待 BUG-009 PR 合并后关闭。 | [Requirement](../05-requirements/REQ-015-rag-production-grounding-closure.md) / [Spec](../../02-delivery-plans/01-specs/2026-06-17-req-015-rag-production-grounding-closure.md) / [Plan](../../02-delivery-plans/02-plans/2026-06-17-req-015-rag-production-grounding-closure-plan.md) / [Report](../../02-delivery-plans/01-specs/2026-06-17-req-015-rag-production-grounding-validation-report.md) |
| BUG-009 | 🟡 Doing | AI Chat 真实 PG 链路未把相关正文 chunk 送入 prompt | 已修共享 `AsyncSession` 并发、RRF 阈值、lexical supplement 排序和邻居 TOC 识别；prompt 前和完整 ask 真实验收均通过，等待 PR 合并。 | [Bug](../05-requirements/BUG-009-ai-chat-rag-retrieval-context-pipeline-real-pg-failure.md) / [Backlog](../04-backlog.md) |
