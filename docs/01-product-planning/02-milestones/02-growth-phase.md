...
| ID | 状态 | 说明 | 归属 |
|----|------|------|------|
| REQ-002 | 🟢 完成 | 模板化结构抽取配置与复用体验：4 子任务链全部收口（REQ-002-1 配置效率 PR #158 / REQ-002-2 复用机制 PR #159 / REQ-002-3 溯源 PR #153 / REQ-002-4 可维护性 PR #170）+ follow-up TD-041 嵌套拖拽 PR #161 + TD-042 PG 集成测试 PR #159/#122。2026-06-21 closeout。后续模板族沉淀与抽取质量见 P2-EXTRACT | [Requirement](../05-requirements/REQ-002-template-config-and-reuse.md) / [Backlog](../04-backlog.md) |
