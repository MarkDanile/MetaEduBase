...
| REQ-018 | 🟡 进行中 | P2-RECALL-4：Slice 1 PR #333 已合并（PgEdgeRetriever 骨架 + RecallResult.edge_id + 5 mock tests）。Slice 2 注入 AIChatService 第 4 通道。 | [Requirement](../05-requirements/REQ-018-p2-four-channel-graph-edge-recall.md) / [Backlog](../04-backlog.md) |
