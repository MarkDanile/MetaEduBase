...
| REQ-026 | 🔵 Ready | P2 RAG 效果比较与弱召回样例集收口：建立更稳定的弱召回样例集和自动质量比较口径，证明 Query Understanding / graph_edge / weighted RRF 对最终回答的真实增益。 | [Requirement](../05-requirements/REQ-026-p2-rag-effect-comparison-and-weak-recall-samples.md) / [Backlog](../04-backlog.md) |
