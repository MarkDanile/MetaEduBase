...
| DOC-042 | DOC | 🟡 Doing | P2 | P3 | 脚本化 TD-032 行数基线扫描 | 将 TD-032 手工 `rg --files ... | xargs wc -l` 扫描固化为稳健命令或脚本，排除 `.venv` / `uploads` / `node_modules` 并支持空格路径 | [Baseline](../03-engineering-governance/02-baselines/td-032-source-file-sizes.md) |
