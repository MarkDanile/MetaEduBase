...
| REQ-008 | REQ | ⚫ Candidate | P1 | P1 | 收口 REQ-004 验收证据与质量门禁缺口 | 修复 REQ-004 相关 ruff 失败，补 `template.select layer=...` 日志验收，补 L3 解析失败 / 空响应覆盖或调整 AC 口径 | [Requirement](05-requirements/REQ-008-req-004-template-selection-quality-follow-up.md) |
