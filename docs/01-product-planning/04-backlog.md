...
| REQ-002 | REQ | 🔵 Ready | P2 | P1 / P2 | 模板化结构抽取能力的配置与复用体验 | 塑形已收口（6 个决策已记录在 [Requirement](05-requirements/REQ-002-template-config-and-reuse.md#决策记录2026-06-10-塑形澄清)）；进入子任务拆分阶段：先建 REQ-002-3 可观测性（contract 扩展先行），再 REQ-002-1 配置效率 / REQ-002-2 复用机制 / REQ-002-4 可维护性 |  |
