...
| REQ-002 | REQ | 🟣 Shaping | P2 | P1 / P2 | 模板化结构抽取能力的配置与复用体验 | 完成塑形并拆分为子任务列表（[Requirement](05-requirements/REQ-002-template-config-and-reuse.md) 已建立：四象限 = 配置效率 / 复用机制 / 可观测性 / 可维护性 + 待回答问题） |  |
