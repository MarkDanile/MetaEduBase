...
| REQ-008 | REQ | 🟢 Done | P1 | P1 | 收口 REQ-004 验收证据与质量门禁缺口 | 已建 [Spec](../02-delivery-plans/01-specs/2026-W23-req-008-req-004-quality-follow-up.md) / [Plan](../02-delivery-plans/02-plans/2026-W23-req-008-req-004-quality-follow-up-plan.md)；修 5 项 ruff 失败（E501/UP035/I001）+ 4 分支 `template.select layer=...` caplog 断言 + 2 条 L3 解析失败 / 空响应用例 + 1 条生产代码漂移保护；行为不变（折行 + import 来源等价）。 | [Requirement](05-requirements/REQ-008-req-004-template-selection-quality-follow-up.md) |
